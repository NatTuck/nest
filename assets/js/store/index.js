...
const initialState = {
  ...
  models: [],
  vocations: [],
  // A suggested space name (adjective-animal) from the lobby's
  // `init` `suggested_name` payload. Pre-fills the new-space form
  // name field. Regenerated by `suggestSpaceName` after a space is
  // created so the next suggestion doesn't collide with the used name.
  suggestedName: null,
  agentsCache: {},
...
export const useStore = create(
  devtools(
    (set, get) => ({
      ...
      /**
       * Set the suggested space name from the lobby `init` payload
       * (or a fresh suggestion from `suggestSpaceName`).
       */
